  ...
  return (
    <section className="sponsors py-12 bg-gray-50">
      <div className="container mx-auto text-center">
        <h2 className="text-4xl font-bold mb-6 text-blue-600">Our Sponsors</h2>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-8">
          {sponsors.map((sponsor, index) => (
            <div key={index} className="sponsor-card bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-all">
