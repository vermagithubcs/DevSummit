  ...
  return (
    <section className="hackathon-prizes py-12 bg-gray-50">
      <div className="container mx-auto text-center">
        <h2 className="text-4xl font-bold mb-6 text-blue-600">Hackathon Prizes</h2>
        <p className="text-lg mb-8 text-gray-700">
          Check out the exciting prizes waiting for you! We've got cash prizes, trophies, internships, and more for the winners.
        </p>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {prizes.map((prize, index) => (
            <div key={index} className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-all">
              <h3 className="text-2xl font-semibold text-blue-600 mb-4">{prize.title}</h3>
              <p className="text-lg font-medium text-gray-800 mb-2">{prize.description}</p>
